...
#include "oled/ledFont.h"
#include "comm/twi.h"

//extern uint8_t cmdBuffer[COMMAND_BUFFER_SIZE];
//extern uint8_t actualDisplayBuffer[DISPLAY_BUFFER_SIZE + 1];
//extern uint8_t * displayBuffer;

static uint8_t cmdBuffer[COMMAND_BUFFER_SIZE] = { // 64
...
//{ 0 };
uint8_t actualDisplayBuffer[DISPLAY_BUFFER_SIZE + 1] = { 0x40, // 128 x 64
    0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55,
    0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55,
    0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55,
    0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55,
...
void clearScreen(void)
{
	...
	int i = 0;
	for (i = 0; i < ACTUAL_DISPLAY_BUFFER_SIZE; i++)
	{
//		sendChar('.');
		actualDisplayBuffer[i] = 0x00;
	}

	actualDisplayBuffer[0] = 0x40;	//continous ram data
//	sendChar('\n');
//	sendString("does this work?\n");
//	sendChar('!');
	return;
}
